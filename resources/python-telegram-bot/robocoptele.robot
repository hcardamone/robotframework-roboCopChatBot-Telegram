...
*** Variables ***
${getMeHeaders}         ./resources/python-telegram-bot/getMeHeaders/headers.json
${getUpdtHeaders}       ./resources/python-telegram-bot/getUpdtHeaders/headers.json
${getUpdtPayload}       ./resources/python-telegram-bot/getMessagePayLoad/payload.json
${postHeaders}          ./resources/python-telegram-bot/postHeaders/headers.json
${sendMpayload}         ./resources/python-telegram-bot/sendMessagePayLoad/sendmsgpayload.json
